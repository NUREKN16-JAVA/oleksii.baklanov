...
public class HsqldbUserDaoTest extends DatabaseTestCase {
    ...
    private static final long ETALON_ID_USER = 2;
    private static final long ETALON_ID_USER_DELETE = 1;
    ...
    public void testUserDelete() {
        try {
            User user = dao.find(ETALON_ID_USER_DELETE);
    ...
    protected IDataSet getDataSet() throws Exception {
     //   return new XmlDataSet(getClass().getClassLoader().getResourceAsStream("F:\\usermanagement_\\src\\test\\resources\\usersDataSet.xml"));
        return null;
    }
}