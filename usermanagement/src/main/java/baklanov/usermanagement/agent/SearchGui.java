...
import baklanov.usermanagement.gui.UserTableModel;
    ...
    class SearchPanel extends JPanel implements ActionListener {
        ...
        protected void doAction(ActionEvent e) throws ParseException {
            if ("ok".equalsIgnoreCase(e.getActionCommand())) {
                String firstName = Validate.validate(getFirstNameField());
                String lastName = Validate.validate(getLastNameField());
